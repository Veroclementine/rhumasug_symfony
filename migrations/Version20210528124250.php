 ...
 */
final class Version20210528124250 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__carrier AS SELECT id, name, description, price FROM carrier');
        $this->addSql('DROP TABLE carrier');
        $this->addSql('CREATE TABLE carrier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, price DOUBLE PRECISION NOT NULL)');
        $this->addSql('INSERT INTO carrier (id, name, description, price) SELECT id, name, description, price FROM __temp__carrier');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__avis_product');
        $this->addSql('CREATE INDEX IDX_F84994ABA76ED395 ON avis_product (user_id)');
        $this->addSql('ALTER TABLE carrier ADD COLUMN created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE carrier ADD COLUMN update_at DATETIME DEFAULT NULL');
        $this->addSql('DROP INDEX IDX_F5299398A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__order AS SELECT id, user_id, reference, full_name, carrier_name, carrier_price, delivery_adress, is_paid, more_informations, created_at FROM "order"');
        $this->addSql('DROP TABLE "order"');
